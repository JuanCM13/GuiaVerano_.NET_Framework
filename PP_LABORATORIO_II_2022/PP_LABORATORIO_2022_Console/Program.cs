using System;
using PP_LABORATORIO_II_2022;

namespace PP_LABORATORIO_2022_Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Fabricante f1 = new Fabricante(EPais.Corea , "Samsung");
            Fabricante f2 = new Fabricante(EPais.China , "Huawei");
            ...
            Celular c4 = new Celular("Iphone 12", new Fabricante(EPais.USA , "Apple"), EGama.Alta);
